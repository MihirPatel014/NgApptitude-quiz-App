...
//   return (
//     <div className="flex flex-col justify-center items-center p-2 mx-auto min-h-screen bg-gray-100 md:p-4">
//       <Toaster />
//       {!showResult ? (
//         <div >
//           {/* Confirmation Modal  */}
...
//           <div className="flex flex-col gap-4 w-4/5 lg:flex-row">
//             {/* Main Quiz Container */}
//             <div className="flex flex-col items-center p-3 bg-white rounded-lg border border-gray-200 shadow md:p-6 bg-custom-gradient lg:w-9/12">
//             {/* Timer (Absolute Positioning) */}
//                 <div className="flex right-4 flex-col ml-auto">
...
//                   )}
//                 </div>
//               <div className="flex justify-center items-center p-4 mb-4 w-full max-w-7xl">
...
//                     src={currentImage || ""}
//                     alt="Question Visual"
//                     className="mr-2 mb-4 w-full rounded-lg md:w-2/5"
//                   />
//                 )} */}
//               </div>

//               {/* Options Grid */}
//               <ul className="grid grid-cols-1 gap-3 px-2 w-full md:grid-cols-2 md:gap-4 md:px-5">
...
//                 ${isSelected ? 'text-white bg-blue-500' : 'text-gray-800 bg-white'}`}
//                         >
//                           {optionLetter}. {option}
//                         </li>
//                       );
...
//               {/* Navigation Buttons */}
//               <div className="grid grid-cols-2 gap-4 px-2 mt-6 w-full md:gap-10 md:px-6 md:mt-9">
//                 <button
...
//             {/* Question Navigator */}
//             <div className="p-3 mt-4 bg-white rounded-lg border border-gray-200 shadow lg:w-2/12 md:p-4 lg:mt-0">
...
//                       className={`px-2 py-1 text-xs font-medium text-center md:px-3 md:py-2 ${bgColorClass}`}
...
//                 className="px-4 py-2 mt-4 w-full text-white bg-red-500 rounded-md hover:bg-red-600"
//               >
//                 End Quiz
//               </button>
//             </div>
