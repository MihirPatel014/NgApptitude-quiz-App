...
const QuizPage = () => {
  ...
  return (
    <div className="flex justify-center items-center p-4 min-h-screen">
      <div className="p-6 w-full max-w-4xl rounded-lg min-h-svh">
              ...
              <div key={packageInfo.id} className="p-6 bg-white rounded-lg shadow-md">
                ...
                <div className="space-y-3">
                  {packageInfo.exams
                    ...
                    .map((exam) => (
                      <div key={exam.examId} className="p-4 w-full bg-white rounded-lg border border-gray-200 shadow-md">
                          ...
                          <div className="mt-4">
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                              {examSections.get(exam.examId)
                                ...
                                .map((section) => (
                                  <div key={section.id} className="p-3 bg-gray-50 rounded-md border border-gray-300">
                        ...
                        {activeTab === "available" && (
                          <button
                            ...
                            className="px-3 py-2 mt-4 w-full text-sm font-medium rounded-lg bg-secondary-light text-secondary hover:bg-secondary-light focus:ring-4 focus:outline-none focus:ring-gray-400"
                          >
                            Start Exam
                          </button>
                        )}
