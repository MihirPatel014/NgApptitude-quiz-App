  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 py-8 bg-gray-100">
      ...
      >
        ...
        <div
          className={`absolute flex flex-col px-10 items-center justify-start transition-all duration-600 ease-in-out w-full md:w-1/2 pt-24 md:pt-10
          ${isRightPanelActive
        ...
        >
          <PhoneOTP onUserNotFound={handleSignUpClick} />
        </div>
